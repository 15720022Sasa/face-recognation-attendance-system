...
path = r'C:\\Users\\zsara\\Downloads\\ATTENDANCE\\image_folder'
...
# Check if 'Attendance.csv' exists in the 'attendance' directory
if 'Attendance.csv' in os.listdir(attendance_dir):
    # Perform your actions here if the file exists
    print("there iss..")
