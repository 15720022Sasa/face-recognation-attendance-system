...
path = r"C:\Users\zsara\Downloads\project\Face_Recognition-main\ImagesAttendance"
only_name = r"C:\Users\zsara\Downloads\project\Face_Recognition-main\only_name"
attend_csv_path = r"C:\Users\zsara\Downloads\project\Attendance.csv"
# GUIIIII
...
def markAttendance(name):
    ...
    with open(r'C:\Users\zsara\Downloads\project\Attendance.csv', 'r+') as f:
...
# mark attendance
def attendance():
    ff = open(r'C:\Users\zsara\Downloads\project\Attendance.csv','w+')
    ss = ""
    try:
    ...
    ff.close()
    os.startfile(r"C:\Users\zsara\Downloads\project\Attendance.csv")
...
def take_a_pic():
    ...
    if new_name in del_names:
        ...
        cv2.imwrite(rf"C:\Users\zsara\Downloads\project\Face_Recognition-main\ImagesAttendance\{new_name}", new_img)
        ...
        images.append(cv2.imread(fr'C:\Users\zsara\Downloads\project\Face_Recognition-main\ImagesAttendance\{new_name}'))
...
def open_images_to_delete():
    L1 = image_names
    L2 = []
    li2 = os.listdir(r"C:\Users\zsara\Downloads\project\Face_Recognition-main\ImagesAttendance")
...
def delete_a_face():
    ...
    root1.title("delete")
    image2 = PhotoImage(file=r"C:\Users\zsara\Downloads\project\Face_Recognition-main\other_files\delete.png")
...
def show():
    os.startfile(r"C:\Users\zsara\Downloads\project\Face_Recognition-main\only_name")


def know_faces():
    os.startfile(r"C:\Users\zsara\Downloads\project\Face_Recognition-main\ImagesAttendance")


def about():
    os.startfile(r"C:\Users\zsara\Downloads\project\Face_Recognition-main\other_files\ABOUT OURSELVES.png")
...
imag = tk.PhotoImage(file=r"C:\Users\zsara\Downloads\project\Face_Recognition-main\other_files\bg4.png")
